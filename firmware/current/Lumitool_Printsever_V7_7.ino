/*
  LUMITOOL PRINTSEVER V7.7 - DISCOVERY + OTA + 3 PRINTER QUEUES
...
String makePage() {
  ...
  p += macSuffix;
  p += "</h1><div class='ver'>V7.7 · Discovery + OTA + 3 Printer</div></div><div class='";
...
String makeSupportPage() {
  ...
  p += "<div class='kv'>Firmware<br><b>V7.7</b></div>";

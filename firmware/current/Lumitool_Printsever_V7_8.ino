/*
  LUMITOOL PRINTSEVER V7.8 - DISCOVERY + OTA + 3 PRINTER QUEUES
...
String makePage() {
  ...
  p += macSuffix;
  p += "</h1><div class='ver'>V7.8 · Discovery + OTA + 3 Printer</div></div><div class='";
...
String makeSupportPage() {
  ...
  p += "<div class='kv'>Firmware<br><b>V7.8</b></div>";

/*
  LUMITOOL PRINTSEVER V7.6 - DISCOVERY + OTA + 3 PRINTER QUEUES
...
void processPrinterQueue(PrinterSlot &p) {
  ...
  if (remaining == 0) {
    ...
    finishJob(
      ...
      *printing,
      true,
      "Transferred to USB printer; TCP completion closed"
    );
...
String makePage() {
  ...
  p += macSuffix;
  p += "</h1><div class='ver'>V7.6 · Discovery + OTA + 3 Printer</div></div><div class='";
...
String makeSupportPage() {
  ...
  p += "<div class='kv'>Firmware<br><b>V7.6</b></div>";

/*
  ESP PRINT SERVER V7.3 - COMPACT UI + SUPPORT OTA + BOOT BUTTON
...
void buildIdentity() {
  ...
  // Support login:
  // username = admin
  // password = device suffix XXXX shown in the device name.
  supportPassword = macSuffix;
}
...
String makePage() {
  ...
  p += macSuffix;
  p += "</h1><div class='ver'>V7.3 · 3 Printer Queue + OTA</div></div><div class='";
...
String makeSupportPage() {
  ...
  p += "<div class='kv'>Firmware<br><b>V7.3</b></div>";

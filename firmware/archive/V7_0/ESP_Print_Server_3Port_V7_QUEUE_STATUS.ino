/*
  ESP PRINT SERVER V7 - 3 PRINTERS + PER-PRINTER JOB QUEUES
...
String makePage() {
  ...
  p += "<div class='muted'>Firmware V7 · 3 independent queues · Windows completion feedback · USB printer status</div>";

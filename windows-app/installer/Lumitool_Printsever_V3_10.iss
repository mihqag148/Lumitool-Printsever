...
OutputDir=..\..\dist
OutputBaseFilename=Lumitool_Printsever_Setup_V3_10
Compression=lzma2
...
[Files]
Source: "..\current\Lumitool_Printsever_Setup_V3_10.ps1"; DestDir: "{app}"; Flags: ignoreversion
...
[Run]
Filename: "powershell.exe"; Parameters: "-NoProfile -ExecutionPolicy Bypass -WindowStyle Hidden -File ""{app}\Lumitool_Watcher_Install_V2.ps1"""; WorkingDir: "{app}"; Flags: runhidden waituntilterminated

...
DirExistsWarning=no
OutputDir=..\..\dist
OutputBaseFilename=Lumitool_Printsever_Setup_V5_0
Compression=lzma2
...
Source: "..\current\Lumitool_Watcher_Install_V3.ps1"; DestDir: "{app}"; Flags: ignoreversion
...
[Run]
Filename: "powershell.exe"; Parameters: "-NoLogo -NoProfile -ExecutionPolicy Bypass -WindowStyle Hidden -File ""{app}\Lumitool_Watcher_Install_V3.ps1"""; WorkingDir: "{app}"; Flags: runhidden waituntilterminated

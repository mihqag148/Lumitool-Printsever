...
$LogPath = Join-Path $env:TEMP "Lumitool_Printsever_Setup_V4_7.log"
...
try {
    ...
    function Invoke-PrintUiAttribute {
        ...
        $p = Start-Process -FilePath $rundll32 -ArgumentList $argLine -WindowStyle Hidden -Wait -PassThru -ErrorAction Stop
    ...
    function Install-PrinterFor {
        ...
        try {
            ...
            if ($existingPrinter) {
                UiLog "QUEUE: printer đã có; giữ queue và cập nhật driver/port"
    ...
    $form.Text = "Lumitool Printsever Setup V4.7"
    ...
    UiLog "Lumitool Printsever Setup V4.7"
    UiLog "Hỗ trợ mọi máy in có driver Windows đã được cài."
    UiLog "A=9101 · B=9102 · C=9103 · Fast Spool · PrintUI · Watcher V2 auto-discovery"

...
$LogPath = Join-Path $env:TEMP "Lumitool_Printsever_Setup_V4_0.log"
...
try {
    ...
    function Configure-RawCompletionMode {
        ...
        # Standard TCP/IP SNMP is not used by Lumitool.
        ...
        # Configure the queue directly with Win32_Printer. No prncnfg.vbs
        # and no Spooler restart are required here.
        try {
        ...
        try {
            ...
            if ($check) {
                ...
                if ([bool]$check.EnableBIDI -or [bool]$check.KeepPrintedJobs -or -not [bool]$check.Direct) {
    ...
    $form.Text = "Lumitool Printsever Setup V4.0"
    ...
    UiLog "Lumitool Printsever Setup V4.0"
    UiLog "Hỗ trợ mọi máy in có driver Windows đã được cài."
    UiLog "A=9101 · B=9102 · C=9103 · Clean Install V4.0 · Watcher V2 auto-discovery"

...
$LogPath = Join-Path $env:TEMP "Lumitool_Printsever_Setup_V4_9.log"
...
try {
    ...
    function Configure-RawCompletionMode {
        ...
        # Keep the vendor queue usable and let Watcher V2 synchronize ESP DONE
        ...
        UiLog "JOB COMPLETION: Watcher V2 sẽ đồng bộ ESP DONE -> Windows"
    }
    ...
    $form.Text = "Lumitool Printsever Setup V4.9"
    ...
    UiLog "Lumitool Printsever Setup V4.9"
    UiLog "Hỗ trợ mọi máy in có driver Windows đã được cài."
    UiLog "A=9101 · B=9102 · C=9103 · RAW compatible · SNMP OFF · Watcher V2 auto-discovery"

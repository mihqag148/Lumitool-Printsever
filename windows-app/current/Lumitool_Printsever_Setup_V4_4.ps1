...
$LogPath = Join-Path $env:TEMP "Lumitool_Printsever_Setup_V4_4.log"
...
'@
    ...
    $form.Text = "Lumitool Printsever Setup V4.4"
    ...
    UiLog "Lumitool Printsever Setup V4.4"

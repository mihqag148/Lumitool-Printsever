...
$LogPath = Join-Path $env:TEMP "Lumitool_Printsever_Setup_V3_10.log"
...
try {
    ...
    $form.Text = "Lumitool Printsever Setup V3.10"
    ...
    UiLog "Lumitool Printsever Setup V3.10"
    UiLog "Hỗ trợ mọi máy in có driver Windows đã được cài."
    UiLog "A=9101 · B=9102 · C=9103 · Watcher V2 auto-discovery · SNMP/BIDI OFF"

...
$LogPath = Join-Path $env:TEMP "Lumitool_Printsever_Setup_V4_2.log"
...
try {
    ...
    $form.Text = "Lumitool Printsever Setup V4.2"
    ...
    UiLog "Lumitool Printsever Setup V4.2"

...
$LogPath = Join-Path $env:TEMP "Lumitool_Printsever_Setup_V3_5.log"
...
try {
    ...
    function Configure-RawCompletionMode {
        ...
        # generic ESP print server cannot provide. V3.5 therefore puts the
    ...
    $form.Text = "Lumitool Printsever Setup V3.5"
    ...
    UiLog "Lumitool Printsever Setup V3.5"
